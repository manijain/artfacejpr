  /* this is for onpage load pagination */
  if (location.pathname.substr(0,15) == "/admin/services") {
    $(function() {
...
// for manage art laywer click on delete art laywer buttton for delete laywer as well as cancel

  $(document).on('click', '#delete_laywer', function(e) {
    e.preventDefault();
    $(".main_ul li.main_li").each(function() {
      $(this).find(".delete_img_onclick").css("display","block");
    });

    $("#delete_laywer").css("display","none")
    $("#cancel_laywer").css("display","inline");
  })

  $(document).on('click', '#cancel_laywer', function() {
    $(".main_ul li.main_li").each(function() {
      $(this).find(".delete_img_onclick").css("display","none");
    });

    $("#delete_laywer").css("display","inline");
    $("#cancel_laywer").css("display","none");
  })

// on mouse over each service partner can edit or delete directly

 $(document).on('mouseover', '.main_li', function(e) {
    e.preventDefault();
  if($(".delete_img_onclick").css("display") == "block"){
    //console.log('In if');
    //$(this).find(".delete_img").addClass('displayImg');
    $(this).find(".delete_img_onmouseover").css("display","none");
    $(this).find(".edit_img").css("display","none"); 
   } 
  else{
    //console.log('In else');
    $(this).find(".delete_img_onmouseover").css("display","block");
    $(this).find(".edit_img").css("display","block");
  }
  })
...
// on click for advaced search find total result



//  on change event sort by colum as well as show per page item
...
$(document).on('change', "#sort_by_attr2, #per_page_item2", function() {
    ...
    if($("#advance_search_two").attr('value') == 'true') {
        urltosend = "/admin/services/search_advanced";
      }
    else if($("#basic_search_two").attr('value') != "") {
        urltosend = "/admin/services/search_basic"
      }  
    else if($("#basic_search_two").attr('value') == "") {
        urltosend = this.href;
      } 
...
// add a validation for number of employee
...
//onclick event service_partner deleted
 $(document).on('click', 'span.delete_img_onclick', function() {
    var service_partner_id = $(this).attr('id');
    console.log($(this).parent());
    if (confirm("Are you sure for delete partner.")) {
       $.ajax({
 ...
 $(document).on('click', 'span.delete_img_onmouseover', function() {
    var service_partner_id = $(this).attr('id');
    var service_partner_type = $(this).attr('partner_type');
    console.log(service_partner_type)
    console.log($(this).parent());
    if (confirm("Are you sure for delete partner.")) {
       $.ajax({
        url: "/admin/services/delete_service_partner",
        ...
        success :function(data){
          console.log('delete success');
          alert('partner deleted')
          if (service_partner_type == 4)
            $('#per_page_item2').change();
          else if (service_partner_type == 3)
            $('#per_page_item3').change();
          else if (service_partner_type == 2)
            $('#per_page_item4').change();
          else if (service_partner_type == 1)
            $('#per_page_item5').change();
        },
        complete: function(data) {          
        } 
      });
...
//validation on add new service partner

$(document).ready(function() {
  $('#service_partner_first_name').live('keyup', function() {
    var isTrue = false
    if($('#service_partner_first_name').val().length == 0){
      $('#error_partner_first_name').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_last_name').live('keyup', function() {
    ...
    if($('#service_partner_last_name').val().length == 0){
      $('#error_partner_last_name').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_company_name').live('keyup', function() {
    ...
    if($('#service_partner_company_name').val().length == 0){
      $('#error_partner_company_name').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_street').live('keyup', function(){
    ...
    if($('#service_partner_street').val().length == 0){
      $('#error_partner_street').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_zip_code').live('keyup', function() {
    ...
    if($('#service_partner_zip_code').val().length == 0){
      $('#error_partner_zip_code').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_city').live('keyup', function() {
    ...
    if($('#service_partner_city').val().length == 0) {
      $('#error_partner_city').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_telephone_number').live('keyup', function() {
    ...
    if($('#service_partner_telephone_number').val().length == 0) {
      $('#error_partner_telephone_number').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_fax_number').live('keyup', function() {
    ...
    if($('#service_partner_fax_number').val().length == 0){
      $('#error_partner_fax_number').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_email').live('keyup', function() {
    ...
    if($('#service_partner_email').val().length == 0){
      $('#error_partner_email').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
  ...
  $('#service_partner_password').live('keyup', function() {
    var isTrue = false
    if($('#service_partner_password').val().length == 0){
      $('#error_partner_password').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
      $('#error_partner_password').attr('data-original-title', 'Please enter password')
      $('#error_partner_password').tooltip()
      return false
    }
    else{
      $('#error_partner_password').hide()
    }
    if(!$('#service_partner_password').val().match( /((?=.*\d)(?=.*[0-9])(?=.*\W).{8,})/ )){
      $('#error_partner_password').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
      $('#error_partner_password').attr('data-original-title', 'Invalid password')
      $('#error_partner_password').tooltip()
      return false
    }
    else{
...
if(location.pathname.substr(0,20) == '/admin/services/new_') {
    ...
    for(var i=1; i<=10; i++){
      switch(i){
        ...
        case 10:
          ...
          else if(!$('#service_partner_password').val().match( /((?=.*\d)(?=.*[0-9])(?=.*\W).{8,})/ )){
            $('#error_partner_password').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
            $('#error_partner_password').attr('data-original-title', 'Please enter valid password')
            $('#error_partner_password').tooltip()
            return false
          }
          break;
  ...
  $(document).on('click', '#send_invitation', function() {
    for(var i =1; i<=3; i++){
      switch(i){
        case 1:
          if($('#service_partner_first_name').val().length == 0){
            alert('Please enter first name to send invitation')
            $('#error_partner_first_name').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
            $('#error_partner_first_name').attr('data-original-title', 'Please enter first name')
            $('#error_partner_first_name').tooltip()
            return false
          ...
          case 2:
            if($('#service_partner_email').val().length == 0){
              alert('Please enter email to send invitation')
              $('#error_partner_email').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
              $('#error_partner_email').attr('data-original-title', 'Please enter email id')
              $('#error_partner_email').tooltip()
              return false
            }
            else if(!$('#service_partner_email').val().match( /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}/i )){
        ...
        case 3:
          if($('#service_partner_password').val().length == 0){
            alert('Please enter password to send invitation')
            $('#error_partner_password').css({'display': 'inline', 'position':'absolute', 'margin-left':'-32px'})
            $('#error_partner_password').attr('data-original-title', 'Please enter password')
            $('#error_partner_password').tooltip()
            return false
