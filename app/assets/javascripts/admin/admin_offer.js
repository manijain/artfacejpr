...
$(function() {
  ...
  if (location.pathname.substr(0,28) == "/admin/users/user_favourites" || location.pathname.substr(0,24) == "/admin/users/user_offers") {
   ...
   $(document).on('click', '.search form input[type=submit]', function() {
      $(".search #offer_temp_sort_one").prop('value', $("#offers_public_page_sort_select").val())
      $(".search #offer_temp_sort_two").prop('value', $("#offers_public_page_sort_active_inactive").val())
      $(".search #offer_temp_sort_three").prop('value', $("#offers_public_page_per_page").val())
    })
    $(document).on('click', '.search_advanced form input[type=submit]', function() {
      $(".search_advanced #offer_temp_sort_one").prop('value', $("#offers_public_page_sort_select").val())
      $(".search_advanced #offer_temp_sort_two").prop('value', $("#offers_public_page_sort_active_inactive").val())
      $(".search_advanced #offer_temp_sort_three").prop('value', $("#offers_public_page_per_page").val())
    })
  ...
  if (location.pathname.substr(0,24) == "/admin/users/user_offers") {
  ...
  if (location.pathname.substr(0,24) == "/admin/users/user_offers") {
    ...
    $('.pagination a').live('click',function () {
      ...
      var offer_search_advanced=$("#offer_search_advanced").attr('value')
      url = "/admin/users/user_offers/search?_=1354783878928&page=1"
      $(document).ajaxStart(function(){
        $("#buy_art_search_loader_gif").show()
        $("#buy_art_search_loader_div").show()
      })
    ...
    $("#offers_public_page_input_button").live('click', function() {
      ...
      var offer_search_advanced=$("#offer_search_advanced").attr('value')
      url = "/admin/users/user_offers/search?_=1354783878928&page=" + $("#offers_public_page_input").val()
      $(document).ajaxStart(function(){
        $("#buy_art_search_loader_gif").show()
        $("#buy_art_search_loader_div").show()
      })
