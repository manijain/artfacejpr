...
// offer sell art area for deleting offers
  ...
  $(document).on('click',"#img_show_documents", function() {  
    ...
    if(location.pathname.substr(0,10) == "/offer/new" || location.pathname.substr(0,11) == "/offer/edit"){
...
if (location.pathname.substr(0,10) == "/offer/new" || location.pathname.substr(0,11) == "/offer/edit") {
  ...
  $( "#new_artist_name" ).autocomplete({
    source: "/offer/find_artist_by_name",
    minLength: 2,
...
// change the medium to previously selected medium
  if (location.pathname == "/offer/new" || location.pathname.substr(0,11) == "/offer/show") {
